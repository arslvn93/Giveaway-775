const config = {
  "meta": {
    "pageTitle": "Win a $450 Parents Spa Escape at Strøm Spa",
  ...
  "giveaway": {
    ...
    "successModalMainMessage": "Your entry for the <strong>Parents Spa Escape for Two at Strøm Spa</strong> is in. We will draw a random winner on November 11th. Good luck and take care of you!",
  ...
  "rules": {
    "faq": [
      ...
      {
        "q": "When does it end?",
        "a": "Entries close on November 10th. The winner is drawn on November 11th. Watch this page and our socials for dates."
      }
    ],
    "tips": [],
  ...
  "footerContact": {
    ...
    "footerDisclaimer": "This giveaway is sponsored by Lisa Hall and is not sponsored by or affiliated with Strøm Spa Nordique. Winner will be selected at random from all eligible entries received before the posted deadline. Must be 18+ and a Canadian resident to enter. No purchase necessary. Void where prohibited.",
    "organizerLogoUrl": "",
    "secondaryLogoUrl": "",
